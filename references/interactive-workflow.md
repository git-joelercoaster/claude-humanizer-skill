# Guided Mode: Worked Walkthroughs

Two full before/after rewrites showing how guided mode works — a technical doc and a personal essay. Each shows the tells, the reasoning, the choices offered, and what the user picked.
